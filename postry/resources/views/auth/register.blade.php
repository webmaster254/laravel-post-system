        ...
        <form action="{{route('register')}}" method="post">
          ...
          @error('password') border-red-500 @enderror" value="{{old('password')}}">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" id="pssword" placeholder="Repeat password" class="bg-gray-100 border-2 w-full p-4 rounded-lg
          @error('password_confirmation') border-red-500 @enderror" value="{{old('password_confirmation')}}">
            ...
            <div>
                <button type="submit" class="bg-blue-500 text-white px-4 py-3 roundednfont-medium w-full">Register</button>
